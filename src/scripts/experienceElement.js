  ...
  connectedCallback() {
    ...
    if (rightSide) {
      this.innerHTML = `
        <div class="flex items-center mr-6 gap-x-5 relative justify-center">
					...
					<div class="experience-text-container flex my-2">
						...
						<p class="experience-text p-3 rounded-l bg-secondary lg:w-[230px]  text-text">${text}</p>
					</div>
				</div>
        `;
    } else {
      this.innerHTML = `
        <div class="flex items-center mr-6 gap-x-5 relative justify-center">
            <div class="experience-text-container flex my-2">
                <p class="experience-text p-3 rounded-l bg-secondary w-[230px]  text-text">${text}</p>
